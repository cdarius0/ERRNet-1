...
class BaseOptions():
    ...
    def initialize(self):
        ...
        self.parser.add_argument('--max_dataset_size', type=int, default=None, help='Maximum number of samples allowed per dataset.'
        ...
        self.parser.add_argument('--display_id', type=int, default=1, help='window id of the web display (use 0 to disable visdom)')
