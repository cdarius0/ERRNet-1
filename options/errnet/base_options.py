...
class BaseOptions(Base):
    def initialize(self):
        ...
        print(Base().parser.argument_default)
        self.parser.add_argument('--inet', type=str, default='errnet', help='chooses which architecture to use for inet.')
        # self.parser.add_argument('--icnn_path', type=str, default='/media/Data/darius/ERRNet_new_pull/ERRNet/checkpoints/'
        #                                                           'Part_of_Big_Dataset_10000_out_of_93570_testing_reflextion_gen_batch_size3_gan_loss_at_epoch_20/errnet_latest.pt',
        #                          help='icnn checkpoint to use.')  # '/media/Data/caius/ERRNet-master/checkpoints/Overlay_no_blur/errnet_latest.pt'
