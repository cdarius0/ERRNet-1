...
class TrainOptions(BaseOptions):
    def initialize(self):
        ...
        self.parser.add_argument('--print_freq', type=int, default=4000,
        ...
        # for training (Note: in train_errnet.py, we mannually tune the training protocol,
        # but you can also use following setting by modifying the code in errnet_model.py)
        ...
        self.parser.add_argument('--vgg_layer', type=int, default=31,
                                 help='vgg layer of unaligned loss')
